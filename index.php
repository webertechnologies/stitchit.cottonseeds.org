...
<div class="content-wrapper">
    ...
    <div class="content-section">
        <div class="content-section-title">Recently Viewed</div>
        <ul>
            <li class="adobe-product">
                ...
                <div class="button-wrapper">
                    <button class="content-button status-button open" onclick="window.location.href='tailorprofile'">
                        View
                    </button>
                    <div class="menu">
            ...
            <li class="adobe-product">
                ...
                <span class="status">
                    ...
                    1 hour ago</span>
                <div class="button-wrapper">
                    <button onclick="window.location.href='tailorprofile'" class="content-button status-button">
                        Fruad User
                    </button>
                    <div class="pop-up">
                        ...
                        <div class="pop-up__subtitle">
                            This tailor reported as fruad by few stitch it
            ...
            <li class="adobe-product">
                ...
                <span class="status">
                    <span class="status-circle green"></span>
                    visited in the year 6954bc
                </span>
                <div class="button-wrapper">
                    <button onclick="window.location.href='tailorprofile'" class="content-button status-button open">
                        View
                    </button>
                    <div class="menu">
                        <button class="dropdown">
        ...
        <div class="apps-card">
            <div class="app-card">
                <span>
                    ...
                    Ammulu Premium Store
                </span>
                <div class="app-card__subtext">
                    Edit, master and create fully proffesional videos
                </div>
                <div class="app-card-buttons">
                    <button onclick="window.location.href='tailorprofile'"
                        class="content-button status-button">order</button>
                    <div class="menu"></div>
                </div>
            </div>
            <div class="app-card">
                ...
                <div class="app-card-buttons">
                    <button onclick="window.location.href='tailorprofile'"
                        class="content-button status-button">Oreder</button>
                    <div class="menu"></div>
                </div>
            </div>
            <div class="app-card">
